...
| Empresa | RUC | Calificación Final | Margen Neto YTD 2026 |
|---|---|:-:|:-:|
| **CMO GROUP S.A.** | 22011489 | 🟠 Alta vigilancia | −560.6% |
| **INTEGRAL CONSULTORES S.A.C.** | 80688541 | 🔴 **CRÍTICA** | +2.7% (único rentable) |
...
| Concepto | CMO | INTEGRAL | MEDARQ | AMERICANA | **Total Grupo** |
|---|---:|---:|---:|---:|---:|
| Ingresos | 211,554 | 2,680,926 | 740,000 | 213,373 | **3,845,853** |
| Costo Directo | 31,822 | 1,326,261 | 6,204 | 270,998 | 1,635,285 |
| Margen Bruto | 179,732 | 1,354,665 | 733,796 | (57,626) | 2,210,567 |
| GAV | 1,356,508 | 1,153,851 | 1,131,251 | 98,035 | 3,739,646 |
| EBITDA | (1,176,776) | 200,814 | (397,455) | (155,660) | **(1,529,078)** |
...
# 3. CONTROL INTERNO — CALIFICACIÓN POR COMPONENTE

| Control Clave | CMO | INTEGRAL | AMERICANA | MEDARQ |
|---|:-:|:-:|:-:|:-:|
| Conciliación bancaria mensual | 🟠 (hasta 2022) | 🔴 (parcial 2024) | 🔴 Nunca | 🔴 Nunca |
| Trazabilidad Pago↔Documento | N/A | 🟢 99.5% | 🟢 99% | 🟢 100% |
| Cumplimiento Ley 28194 (Bancarización) | 🟢 100% | 🟢 100% | 🟢 100% | 🟢 100% |
| CTS depósito mayo | 🟢 | 🟢 | 🔴 | 🔴 |
| CTS depósito noviembre | 🟢 | 🟢 | 🟢 | 🟢 |
| Participaciones DL 892 | ✅ | 🔴 Pendiente | ✅ | ✅ |
| Depreciación NIC 16 | 🔴 Inversa | 🟢 | 🟢 | 🟢 |
| Reserva Legal (Art. 229 LGS) | 🔴 Ausente | 🔴 Ausente | 🔴 Ausente | 🔴 Ausente |
| Capital social registrado | 🔴 Sin apertura 2026 | 🔴 S/1K | 🔴 S/1K | 🟢 S/1.2M |
...
| # | Acción |
|:-:|---|
| 10 | Formalizar contratos de mutuo intercompañía (S/123M) |
| 11 | Aprobar Reserva Legal retroactiva en Junta de Accionistas |
| 12 | Capitalizar INTEGRAL y AMERICANA (capital S/1,000 → razonable) |
| 13 | Reactivar conciliación bancaria mensual en las 4 empresas |
| 14 | Dar de alta cuentas bancarias de 36 beneficiarios |
| 15 | Provisión por intereses devengados préstamos intercompañía (CMO) |
...
2. **Aprobar presupuesto** para contratación antes del 30/06/2026 de:
   - Especialista en Precios de Transferencia (~US$15-20K)
   - Asesoría tributaria preventiva (~US$8-12K)
   - Auditoría externa Big 4 EEFF 2025 (~US$30-50K)

## 5.2. Comité de Remediación

Constituir un Comité de Remediación con representantes de:
- CFO del grupo
- Contadores de cada empresa
- Gerente Financiero
- Asesoría legal externa

Frecuencia: reuniones semanales durante 90 días, luego mensuales.

## 5.3. Reportes al Directorio

- Reporte mensual del dashboard s10bizsmarthub con TOP hallazgos
- Avance del plan de remediación (semáforo por acción)
- KPIs de control interno (conciliaciones firmadas, CTS al día, etc.)

## 5.4. Compromiso del Sistema

s10bizsmarthub está operativo con **99% de confiabilidad** sobre datos auditables del ERP S10. Cubre:

- P&L y Estado de Resultados (100%)
- Balance General y Patrimonio (100%)
- Activo Fijo + Depreciación (100%)
- Tesorería contable (100%)
- Conciliación Bancaria (100%)
- Libro de Pagos / Trazabilidad (100%)
- Bancarización Ley 28194 (100%)
- CxC / CxP / Documentos (100%)
- Auditoría (descuadres, sin doc, atípicos) (100%)
- Tributos clase 40 (95%)
- Laboral agregado (95%)
...
- ✅ **100% de cumplimiento de Ley 28194 (Bancarización)** — histórico y actual
- ✅ **Trazabilidad Pago↔Documento del 99%+** en las 3 empresas operativas
- ✅ **Activo Fijo correctamente registrado** (tras fix de mapeo)
- ✅ **INTEGRAL es rentable** — proteger ese flujo
- ✅ **Documentación contable existente** para soportar argumentos ante SUNAT

## 6.2. Lo malo (gaps críticos)

- 🔴 **Control interno bancario deficiente** — 3 de 4 empresas no concilian con el banco real
- 🔴 **Operación intercompañía no formalizada** — S/123M en préstamos sin contratos de mutuo
- 🔴 **Pérdidas significativas** — solo INTEGRAL rentable; AMERICANA con margen bruto negativo
- 🔴 **MEDARQ sueldos atrasados** — riesgo de fuga de talento y demandas
- 🔴 **CTS mayo 2025 omitida** en AMERICANA y MEDARQ — riesgo SUNAFIL
